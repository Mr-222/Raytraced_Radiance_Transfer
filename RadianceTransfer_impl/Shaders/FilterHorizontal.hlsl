...
void spatialFilter(float2 uv)
{
    ...
    for (int i = -radius; i <= radius; ++i)
    {
        ...
        {
            sumOfWeights += 1.0;
            filteredColor += screenSpaceThisFrameSHCoeffs[0][uv];
            continue;
        }
        ...
        float3 colorJ = screenSpaceThisFrameSHCoeffs[0].Load(int3(uv.x+ i, uv.y, 0));
